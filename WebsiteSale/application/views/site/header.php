                    ...
                    <ul class="menu-default__list">
                        <?php foreach ($data['catalog'] as $cata): ?>
                            <?php if (!empty($cata->subs)): ?>
                                <li class="menu-default__item"><a href="<?php echo getFullHost() . "/product/product-follow-catalog/" . $cata->id ?>" class="menu-default__link menu-default__link--icon"><?php echo $cata->name ?></a>
                                    <ul class="menu-default__sub-menu">
                                        <?php foreach ($cata->subs as $row): ?>
                                            <?php if (!empty($row->subs2)): ?>
                                                <li class="menu-default__item"><a href="<?php echo getFullHost() . "/product/product-follow-catalog/" . $row->id ?>" class="menu-default__link menu-default__link--icon"><?php echo $row->name ?></a>
                                                    <ul class="menu-default__sub-menu">
