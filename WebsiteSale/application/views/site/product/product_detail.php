...
<<<<<<< HEAD
                                        <div class="box-product box-product--product">
                                            ...
                                            <div class="box-product__content">
                                                ...
                                                <p class="box-product__description"><?php echo $pro_concern->introduce ?></p>
                                                <div class="box-product__price"><span class="box-product__new-price"><?php echo number_format($pro_concern->price * (100 - $pro_concern->discount) / 100) ?>₫</span><span class="box-product__old-price"><?php echo number_format($pro_concern->price) ?>₫</span></div>
