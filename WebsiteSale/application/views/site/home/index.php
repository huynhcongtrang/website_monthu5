                    ...
                    <?php foreach ($data['service_list'] as $service): ?>
                        <div class="col-3">
                            <div class="box-product box-product--services box-product--custom-title box-product--hover">
                                <div class="box-product__image"><a href="#" class="box-product__link--image"><img src="<?php echo public_url('/assets/images/section-services/') . $service->image_link ?>" alt="Thi công màn chống thấm vnbuilding" class="box-product__photo"></a></div>
                                <div class="box-product__content">
                                    <h3 class="box-product__title"><a href="#" class="box-product__link box-product__link--title"><?php echo $service->name ?></a></h3>
