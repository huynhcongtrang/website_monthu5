                            ...
                            <div class="col-3">
                                <div class="box-product box-product--product">
                                    ...
                                    <div class="box-product__content">
                                        <h3 class="box-product__title"><a href="<?php echo getFullHost() . '/product/view-detail/' . $product->id ?>" class="box-product__link box-product__link--title"><?php echo $product->name ?></a></h3>
